...
class Catboost_v1_1_2020:
    ...
    def __init__(self):
        self.clf1 = CatBoostClassifier()
        self.clf1.load_model(
            'Notebooks/Catboost_v1_1_2020/data_models/catboost_v1_1_13.04.2021_1.cat')
        self.model_cols1 = self.clf1.feature_names_

        self.clf2 = CatBoostClassifier()
        self.clf2.load_model(
            'Notebooks/Catboost_v1_1_2020/data_models/catboost_v1_1_13.04.2021_2.cat')
        self.model_cols2 = self.clf2.feature_names_

        # TODO replace fighters df to f_stats_events_cumulative
        self.f_stats_events_cumulative = pd.read_csv(
            'Notebooks/Catboost_v1_1_2020/data_models/PROD_f_stats_events_cumulative_prod_08.04.2021.csv',
            index_col=0)
        self.f_stats_events_cumulative['eventDate.date'] = pd.to_datetime(
            self.f_stats_events_cumulative['eventDate.date'])

        self.generated_features = json.load(
            open('Notebooks/Catboost_v1_1_2020/data_models/generated_features_08.04.2021.txt',
                 'r'))
        self.num_cols = [i[3:] for i in self.generated_features['fighter1_stats']][:-8]
...
class Catboost_v1_2_2020:
    ...
    def __init__(self):
        self.clf1 = CatBoostClassifier()
        self.clf1.load_model(
            'Notebooks/Catboost_v1_2_2020/data_models/catboost_v1_2_13.04.2021_1.cat')
        self.model_cols1 = self.clf1.feature_names_

        self.clf2 = CatBoostClassifier()
        self.clf2.load_model(
            'Notebooks/Catboost_v1_2_2020/data_models/catboost_v1_2_13.04.2021_2.cat')
        self.model_cols2 = self.clf2.feature_names_

        # TODO replace fighters df to f_stats_events_cumulative
        self.f_stats_events_cumulative = pd.read_csv(
            'Notebooks/Catboost_v1_2_2020/data_models/PROD_f_stats_events_cumulative_prod_08.04.2021.csv',
            index_col=0)
        self.f_stats_events_cumulative['eventDate.date'] = pd.to_datetime(
            self.f_stats_events_cumulative['eventDate.date'])

        self.generated_features = json.load(
            open('Notebooks/Catboost_v1_2_2020/data_models/generated_features_08.04.2021.txt',
                 'r'))
        self.num_cols = [i[3:] for i in self.generated_features['fighter1_stats']][:-8]
...
class Catboost_v1_1_copy1:
    ...
    def predict_fight(self, f1_id, f2_id, event_date, f1_odd, f2_odd,
        ...
        y_proba1_1 = self.clf1.predict_proba(X_df[self.model_cols1])[:, 1]
        y_proba1_2 = self.clf1.predict_proba(X_df_reversed[self.model_cols1])[:, 0]

        y_proba2_1 = self.clf2.predict_proba(X_df_reversed[self.model_cols2])[:, 0]
        y_proba2_2 = self.clf2.predict_proba(X_df[self.model_cols2])[:, 1]

        y_proba1 = (y_proba1_1+y_proba1_2)/2
        y_proba2 = (y_proba2_1+y_proba2_2)/2
